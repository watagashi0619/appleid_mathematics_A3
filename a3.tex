...
\begin{thm}[たたみこみとフーリエ変換の関係]\label{thm:3-17}
	...
	\begin{enumerate}
		...
		\item $f, g, \hat{g}\in L^1(\mathbb{R})$が有界ならば
		      \[
			      \begin{split}
				      \mathcal{F}[fg](\xi)&=\frac{1}{\sqrt{2\pi}}\mleft(\hat{f}*\hat{g}\mright)(\xi) \\
				      \mathcal{F}^*[fg](t)&=\frac{1}{\sqrt{2\pi}}\mleft(\check{f}*\check{g}\mright)(t)
			      \end{split}
		      \]
	\end{enumerate}
\end{thm}
